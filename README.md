...
🚀 **NEWS: THE OPENMEVA BENCHMARK ARE AVAILABLE AT 🤗 [HuggingFace](https://huggingface.co/datasets/Jiann/OpenMEVA/tree/main) NOW**.
...
* [Benchmark](#benchmark)
  * [I. Datasets](#i-datasets)
    * [MAGS](#1-machine-generated-stories-mags-with-manual-annotation)
    * [ACTS](#2-auto-constructed-stories-acts)
    * [Download & Instruction](#3-download--data-instruction)
  * [II. Tasks](#ii-tasks)
    * [Correlation](#1-correlation-with-human-scores-based-on-mags)
    * [Generalization](#2-generalization-across-generation-models-and-dataset-for-learnable-metrics-based-on-mags)
    * [Judgment](#3-judgment-in-general-linguistic-features--based-on-the-discrimination-test-set-of-acts)
    * [Robustness](#4-robustness-to-rationality-preserving-perturbations--based-on-the-invariance-test-set-of-acts)
    * [Fast Test](#5-fast-test)
